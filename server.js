    ...
    db.get('SELECT COUNT(*) as count FROM users', (err, row) => {
      ...
      if (row.count === 0) {
        ...
        const mockUsers = [
          ...
          { name: 'Karim Uddin', email: 'karim@gmail.com', phone: '01780808080', password: hashedPassword, blood_group: 'A-', location: 'Badda, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Laila Begum', email: 'laila@gmail.com', phone: '01790909090', password: hashedPassword, blood_group: 'B-', location: 'Khilgaon, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Asif Iqbal', email: 'asif@gmail.com', phone: '01720202020', password: hashedPassword, blood_group: 'AB-', location: 'Tejgaon, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Tanvir Islam', email: 'tanvir@gmail.com', phone: '01730303030', password: hashedPassword, blood_group: 'O+', location: 'Mirpur, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Rina Sen', email: 'rina@gmail.com', phone: '01740404040', password: hashedPassword, blood_group: 'A+', location: 'Uttara, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Kamal Pasha', email: 'kamal@gmail.com', phone: '01750505050', password: hashedPassword, blood_group: 'B+', location: 'Dhanmondi, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Sumi Akter', email: 'sumi@gmail.com', phone: '01760606060', password: hashedPassword, blood_group: 'O-', location: 'Mohammadpur, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Pavel Islam', email: 'pavel@gmail.com', phone: '01770707070', password: hashedPassword, blood_group: 'AB+', location: 'Banani, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Farhana Yasmin', email: 'farhana@gmail.com', phone: '01788889999', password: hashedPassword, blood_group: 'A-', location: 'Gulshan, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Sajib Ahmed', email: 'sajib@gmail.com', phone: '01799998888', password: hashedPassword, blood_group: 'B-', location: 'Badda, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Rubel Hossain', email: 'rubel@gmail.com', phone: '01711122233', password: hashedPassword, blood_group: 'O+', location: 'Khilgaon, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Salma Khatun', email: 'salma@gmail.com', phone: '01722233344', password: hashedPassword, blood_group: 'A+', location: 'Tejgaon, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Arifur Rahman', email: 'arif@gmail.com', phone: '01733344455', password: hashedPassword, blood_group: 'B+', location: 'Mirpur, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Jesmin Ara', email: 'jesmin@gmail.com', phone: '01744455566', password: hashedPassword, blood_group: 'AB-', location: 'Uttara, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Shakil Khan', email: 'shakil@gmail.com', phone: '01755566677', password: hashedPassword, blood_group: 'O+', location: 'Dhanmondi, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Lipi Adhikary', email: 'lipi@gmail.com', phone: '01766677788', password: hashedPassword, blood_group: 'A-', location: 'Mohammadpur, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Monirul Islam', email: 'monirul@gmail.com', phone: '01777788899', password: hashedPassword, blood_group: 'B-', location: 'Banani, Dhaka', role: 'donor', is_available: 1 },
          { name: 'Sadia Afrin', email: 'sadia@gmail.com', phone: '01788899900', password: hashedPassword, blood_group: 'O-', location: 'Gulshan, Dhaka', role: 'donor', is_available: 1 },
